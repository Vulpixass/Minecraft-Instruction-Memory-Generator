...
It takes in your Pseudo Code and turn it into a "memory_towers.schem" file in whatever Directory you want in this Version of the program: "PseudoCODE to .schem, ADVANCED" by changing the Directory under: "Save schematic" or for the classic schematic Directory with this Version: "PseudoCODE to .schem"
...
EXAMPLE PROGRAM:
LDI 1 2       # Loads into R1 a 2
LDI 2 17      # Loads into R2 a 17
ADD 1 2 3     # Adds R1 and R2 and loads the Output into R3(19)
SUB 1 0 4     # Subtracts R1 from R0 and loas the Output into R4(2)
BRH Z 8       # Jumps to Line 8 if the Flag Zero is triggered(False)
CAL 7         # Calls Line 7
HLT           # Halts the Program
RSH 4 0 4     # Divides R4 by 2, Outputs to R4(1)
JMP 9         # Jumps to Line 9
RET           # Returns to the last Call Line +1
HLT           # Halts the Program(Unused)
